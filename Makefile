...
pkgdatadir = $(datadir)/game
pkgincludedir = $(includedir)/game
pkglibdir = $(libdir)/game
pkglibexecdir = $(libexecdir)/game
...
am_game_OBJECTS = game-main.$(OBJEXT)
...
ACLOCAL = ${SHELL} /home/bobpaw/game/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/bobpaw/game/missing autoconf
AUTOHEADER = ${SHELL} /home/bobpaw/game/missing autoheader
AUTOMAKE = ${SHELL} /home/bobpaw/game/missing automake-1.15
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/bobpaw/game/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = game
PACKAGE_BUGREPORT = aiden.woodruff@gmail.com
PACKAGE_NAME = game
PACKAGE_STRING = game 1.0
PACKAGE_TARNAME = game
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/bobpaw/game
abs_srcdir = /home/bobpaw/game
abs_top_builddir = /home/bobpaw/game
abs_top_srcdir = /home/bobpaw/game
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/bobpaw/game/install-sh
...
game-main.o: main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(game_CFLAGS) $(CFLAGS) -MT game-main.o -MD -MP -MF $(DEPDIR)/game-main.Tpo -c -o game-main.o `test -f 'main.c' || echo '$(srcdir)/'`main.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/game-main.Tpo $(DEPDIR)/game-main.Po
#	$(AM_V_CC)source='main.c' object='game-main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(game_CFLAGS) $(CFLAGS) -c -o game-main.o `test -f 'main.c' || echo '$(srcdir)/'`main.c

game-main.obj: main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(game_CFLAGS) $(CFLAGS) -MT game-main.obj -MD -MP -MF $(DEPDIR)/game-main.Tpo -c -o game-main.obj `if test -f 'main.c'; then $(CYGPATH_W) 'main.c'; else $(CYGPATH_W) '$(srcdir)/main.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/game-main.Tpo $(DEPDIR)/game-main.Po
